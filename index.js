...
ig.module("game.entities.babyDragon_anim")
    ...
    .defines(function () {
        BabyDragonAnim = ig.Entity.extend({
            ...
            update: function () {
                this.parent();
                if (this.pauseGame == 0 && this.dieFall == 0) {
            ...
            draw: function () {
                ...
                if (this.isgameover == 1) {
                    area.rotate(180 * Math.PI / 180);
                    if (this.dieFall == 0) {
                        this.dieFall = 1;
                        if (MJS.view.viewport.orientation.portrait) {
                            this.tween({ posCurrent: { x: this.posCurrent.x, y: 800 } }, 0.8, {
                                onComplete: function () {

                                }.bind(this),
                            }).start();
                        } else {
                            this.tween({ posCurrent: { x: this.posCurrent.x, y: 480 } }, 0.8, {
                                onComplete: function () {
...
ig.module("game.entities.game-control")
    ...
    .defines(function () {
        EntityGameControl = ig.Entity.extend({
            ...
            imageRedAlart: new ig.Image(imagePath.redalart),
            ...
            draw: function () {
                ...
                if(this.isRedAlart == 1){
                    this.drawRedAlart();
                }
            },

            isRedAlart: 0,
            drawRedAlart: function(){
                if (MJS.view.viewport.orientation.portrait) {
                    var area = ig.system.context;
                    area.save();
                    area.translate(270, 480);
                    area.scale(0.5, 0.5);
                    this.imageRedAlart.draw(-this.imageRedAlart.width / 2, -this.imageRedAlart.height / 2);
                    area.restore();
                }else{
                    var area = ig.system.context;
                    area.save();
                    area.translate(478, 270);
                    area.scale(0.92, 0.29);
                    this.imageRedAlart.draw(-this.imageRedAlart.width / 2, -this.imageRedAlart.height / 2);
                    area.restore();
                }
